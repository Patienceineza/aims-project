...
export default function DataTableV2<Entry extends {}>(
  ...
  return (
    <div className="panel">
    {/* Toolbar Section */}
    <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-4 bg-white dark:bg-slate-900 shadow rounded-lg">
      ...
      <div className="w-full md:w-1/3">
        <input
          type="text"
          className="form-input w-full p-2 border rounded shadow-sm"
          placeholder="Search..."
          value={search}
    ...
    <div className="bg-white dark:bg-slate-900 p-4 rounded-lg shadow">
      <DataTable
        highlightOnHover
        className="w-full whitespace-nowrap table-hover"
        records={props.data}
        ...
        columns={[
          {
            ...
            render: (_, index) => (
              <p className="text-gray-700 dark:text-gray-300 font-medium">
                {paginate.pageSize * props.currentPage - paginate.pageSize + index + 1}
              </p>
            ),
          },
          ...props.columns,
