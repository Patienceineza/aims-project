...
export default function DataTableSales<Entry extends {}>(
  ...
  const handleExportSalesPDF = () => {
    const doc: any = new jsPDF({ orientation: "landscape" }); // Landscape orientation
  
    doc.text("Sales Report", 14, 10); // Title of the PDF
    ...
    doc.save("sales_report.pdf"); // Save the PDF with the sales report
  };
      ...
      <div className="panel">
        <div className="flex flex-col md:flex-row items-center justify-between mb-6 gap-4 p-4 bg-white dark:bg-slate-900 shadow rounded-lg">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button onClick={handleExportSalesPDF} className="btn btn-primary btn-sm flex items-center gap-2">
            <IconFile className="w-5 h-5" />
            <span>PDF</span>
            </button>
